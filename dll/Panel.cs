...
public class Panel : IActionListener, IChatable
{
    ...
    private void updateKeyScrollView()
    {
        ...
        bool flag = false;
        if (type == 3 && GameCanvas.isPointerHoldIn(wScroll - 35, yScroll, 35, hScroll))
        {
            GameCanvas.clearAllPointerEvent();
            if (!LoadMap.isAutoJoinZone)
            {
                new Thread(new ParameterizedThreadStart(LoadMap.autoJoinZone)).Start((cmtoY + GameCanvas.py - yScroll) / ITEM_HEIGHT);
                return;
            }
    ...
    private void paintPetInventory(mGraphics g)
    {
        ...
        for (int i = 0; i < arrItemBody.Length + arrPetSkill.Length; i++)
        {
            ...
            if (item != null)
            {
                ...
                if (item.itemOption != null)
                {
                    ...
                    if (item.itemOption.Length > 1)
                    {
                        for (int l = 1; l < item.itemOption.Length; l++)
                        {
                            if (item.itemOption[l] != null && item.itemOption[l].optionTemplate.id != 102 && item.itemOption[l].optionTemplate.id != 107)
                            {
                                if (item.template.type > 4 && item.template.type != 32)
                                {
                                    text2 = text2 + "," + item.itemOption[l].getOptionString();
                                }
                                ...
                                {
                                    for (int z = 0; z < item.itemOption.Length; z++)
                                    {
                                        if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 77)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% HP";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 94)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% Giáp";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 95)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% HM";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 96)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% HK";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 97)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% PST";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 98)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% XGC";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 99)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% XGCC";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 100)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% GOLD";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 101)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% TNSM";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 103)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% KI";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 108)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% NÉ";
                                        }
                                        else if (item.itemOption[z] != null && item.itemOption[z].optionTemplate.id == 50)
                                        {
                                            inforItemOption = $"{item.itemOption[z].param}% SĐ";
                                        }
                                    }
                                }
                            }
                ...
                mFont.tahoma_7_blue.drawString(g, inforItemOption, 170, this.yScroll + i * this.ITEM_HEIGHT + 13, mFont.RIGHT);
                if (item.itemOption != null)
                {
                    for (int m = 0; m < item.itemOption.Length; m++)
                    {
                    ...
                    for (int num10 = 0; num10 < item.itemOption.Length; num10++)
                    {
                        ...
                        if (item.itemOption[num10].param > 0)
                        {
                            if (item.itemOption[num10].optionTemplate.id == 102)
                            {
                                text3 = item.itemOption[num10].param.ToString();
                            }
                            else if (item.itemOption[num10].optionTemplate.id == 107)
                            {
                                text3 = item.itemOption[num10].param.ToString();
                            }
                        }
                        ...
                        {
                            mFont.tahoma_7b_red.drawString(g, text3, 160, this.yScroll + i * this.ITEM_HEIGHT, 0, mFont.tahoma_7b_dark);
                            g.drawImage(Panel.imgStar, 165, this.yScroll + i * this.ITEM_HEIGHT + 1);
                        }
                    }
                }
                if (item.quantity > 1)
    ...
    private void paintZone(mGraphics g)
    {
        ...
        for (int i = 0; i < pts.Length; i++)
        {
            ...
            g.fillRect(wScroll - 34, y, 36, h2, 43520, 90);
            mFont.tahoma_7.drawString(g, "Auto", wScroll - 15, num2 + 6, 3);
        }
        paintScrollArrow(g);
    }
    ...
    private void paintBox(mGraphics g)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < currentListLength; i++)
            {
                ...
                SmallImage.drawSmallImage(g, item.template.iconID, num5 + num7 / 2, num6 + num8 / 2, 0, 3);
                mFont.tahoma_7_blue.drawString(g, inforItemOption, this.xScroll + this.wScroll - 2, this.yScroll + i * this.ITEM_HEIGHT + 11, mFont.RIGHT);
                if (item.itemOption != null)
                {
                    for (int n = 0; n < item.itemOption.Length; n++)
                    {
                    ...
                    for (int num10 = 0; num10 < item.itemOption.Length; num10++)
                    {
                        ...
                        {
                            mFont.tahoma_7b_red.drawString(g, text3, 160, this.yScroll + i * this.ITEM_HEIGHT, 0, mFont.tahoma_7b_dark);
                            g.drawImage(imgStar, 165, this.yScroll + i * this.ITEM_HEIGHT + 1);
                        }
                    }
                }
                if (item.quantity > 1)
    ...
    private void paintInventory(mGraphics g)
    {
        ...
        currentListLength = arrItemBody2.Length + arrItemBag2.Length;
        try
        {
            for (int num22 = 0; num22 < currentListLength; num22++)
            {
                ...
                g.setColor((num22 == this.selected) ? 16383818 : ((num22 >= arrItemBody2.Length) ? 15723751 : 15196114));
                g.fillRect(num23, num24, num25, h2);
                g.setColor((num22 == this.selected) ? 9541120 : ((num22 >= arrItemBody2.Length) ? 11837316 : 9993045));
                Item item3 = (num22 >= arrItemBody2.Length) ? arrItemBag2[num22 - arrItemBody2.Length] : arrItemBody2[num22];
                if (item3 != null)
                {
                ...
                if (item3.itemOption != null)
                {
                    for (int num31 = 0; num31 < item3.itemOption.Length; num31++)
                    {
                        ...
                        if (num22 > 9)
                        {
                            StringHandle.drawStringBd(mFont.tahoma_7_yellow, g, (num22 - 9).ToString(), this.xScroll + 2, this.yScroll + num22 * this.ITEM_HEIGHT - 2, 0, mFont.tahoma_7);
                        }
                    }
                }
                ...
                if (item3.itemOption != null)
                {
                    ...
                    if (item3.itemOption.Length > 1)
                    {
                        ...
                        if (item3.template.type >= 0 && item3.template.type <= 4)
                        {
                            for (int i = 0; i < item3.itemOption.Length; i++)
                            {
                                if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 77)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% HP";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 94)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% Giáp";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 95)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% HM";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 96)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% HK";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 97)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% PST";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 98)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% XGC";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 99)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% XGCC";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 100)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% GOLD";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 101)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% TNSM";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 103)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% KI";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 108)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% NÉ";
                                }
                                else if (item3.itemOption[i] != null && item3.itemOption[i].optionTemplate.id == 50)
                                {
                                    inforItemOption = $"{item3.itemOption[i].param}% SĐ";
                                }
                            }
                        }
                    }
                ...
                mFont.tahoma_7_blue.drawString(g, inforItemOption, this.xScroll + this.wScroll - 2, this.yScroll + num22 * this.ITEM_HEIGHT + 11, mFont.RIGHT);
                if (item3.itemOption != null)
                {
                    ...
                    for (int num10 = 0; num10 < item3.itemOption.Length; num10++)
                    {
                        string text5 = string.Empty;
                        if (item3.itemOption[num10].param > 0)
                        {
                            if (item3.itemOption[num10].optionTemplate.id == 102)
                            {
                                text5 = item3.itemOption[num10].param.ToString();
                            }
                            else if (item3.itemOption[num10].optionTemplate.id == 107)
                            {
                                text5 = item3.itemOption[num10].param.ToString();
                            }
                        }
                        ...
                        {
                            mFont.tahoma_7b_red.drawString(g, text5, this.xScroll + this.wScroll - 17, this.yScroll + num22 * this.ITEM_HEIGHT, 0, mFont.tahoma_7b_dark);
                            g.drawImage(imgStar, this.xScroll + this.wScroll - 11, this.yScroll + num22 * this.ITEM_HEIGHT + 1);
                        }
                    }
                }
                if (item3.quantity > 1)
    ...
    private void doFireShop()
    {
        ...
        else if (typeShop == 0)
        {
            ...
            if (this.selected >= arrItemBody.Length)
            {
                ...
                Item item = Char.myCharz().arrItemBag[(int)b];
                if (item != null)
                {
                    this.currItem = item;
                }
            ...
            {
                Item item2 = Char.myCharz().arrItemBody[this.selected];
                if (item2 != null)
                {
                    this.currItem = item2;
                }
    ...
    private void doFireBox()
    {
        ...
        {
            Item item = Char.myCharz().arrItemBox[this.selected];
            if (item != null)
            {
                if (item.isTypeBody())
                {
        ...
        if (this.currentTabIndex == 1 || this.Equals(GameCanvas.panel2))
        {
            ...
            {
                sbyte b = (sbyte)(this.selected - arrItemBody.Length);
                Item item2 = Char.myCharz().arrItemBag[(int)b];
                if (item2 != null)
                {
            ...
            {
                Item item3 = Char.myCharz().arrItemBody[this.selected];
                if (item3 != null)
                {
    ...
    public void perform(int idAction, object p)
    {
        ...
        if (idAction == 2001)
        {
            Res.outz("use item");
            Item item9 = (Item)p;
            bool flag = this.selected < Char.myCharz().arrItemBody.Length;
            sbyte b = 0;
            if (!flag)
            {
                b = (sbyte)(this.selected - Char.myCharz().arrItemBody.Length);
            }
            Service.gI().useItem(0, (sbyte)((!flag) ? 1 : 0), (sbyte)((!flag) ? ((int)b) : this.selected), -1);
        ...
        if (idAction == 2003)
        {
            ...
            bool flag2 = this.selected < Char.myCharz().arrItemBody.Length;
            sbyte b2 = 0;
            if (!flag2)
            {
                b2 = (sbyte)(this.selected - Char.myCharz().arrItemBody.Length);
            }
            Service.gI().useItem(1, (sbyte)((!flag2) ? 1 : 0), (sbyte)((!flag2) ? ((int)b2) : this.selected), -1);
        }
        if (idAction == 2004)
        {
            GameCanvas.endDlg();
        ...
        if (idAction == 3002)
        {
            GameCanvas.endDlg();
            Item item12 = (Item)p;
            Service.gI().saleItem(0, (sbyte)((this.selected > 6) ? 1 : 0), (short)((this.selected >= 7) ? (this.selected - 6 - 1) : this.selected));
        }
        if (idAction == 3003)
        {
            GameCanvas.endDlg();
